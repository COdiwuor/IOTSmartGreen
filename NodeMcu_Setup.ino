...
#define FIREBASE_HOST "smartgreen-a7a42.firebaseio.com"// the project name address from firebase id
#define FIREBASE_AUTH "zzlA53whPCnWH8T0Ot6nWWp2qzZGyfgvP69hdFgP"// the secret key generated from firebase
#define WIFI_SSID "OMASETE"// input your home or public wifi name 
#define WIFI_PASSWORD "omasete123"//password of wifi ssid
...
int value = 0;
int sensorPin = A0; // Soil Sensor input at Analog PIN A0 nodemcu
int output_value ;                                                    
void setup() {
...
void loop() { 
  ...
  Firebase.pushString("/Smart_Green_Data/Soil Moisture", fireMoisture);//setup path and send readings
